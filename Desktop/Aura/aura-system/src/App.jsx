...
export default function App() {
  ...
  useEffect(() => {
    // Join a global "all" room so every client gets emergency broadcasts
    socket.emit('join_emergency', { role: activeRole, emergency_id: 'all' });
    ...
    // FIX: Listen for 'emergency_assigned' (what backend actually emits)
    socket.on('emergency_assigned', (data) => {
      console.log('emergency_assigned received:', data);
      setEmergency(data);
    });
